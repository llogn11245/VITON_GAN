...
def main():
    ...
    dataset_train = TOMDataset(opt, mode='train', data_list='/content/viton_gan/train_pairs.txt')
    dataloader_train = DataLoader(dataset_train, batch_size=opt.batch_size, num_workers=opt.n_worker, shuffle=True)
    dataset_val = TOMDataset(opt, mode='test', data_list='/content/viton_gan/test_pairs.txt', train=False)
